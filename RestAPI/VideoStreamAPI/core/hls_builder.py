...
class HLSBuilder:
  ...
  def __init__(self, video, **kwargs):
    ...
    self.video_variants: list[dict[str,str]] = [
      {"bandwidth_ffmpeg": "400k", "bandwidth": 400000, "resolution": "426x240", "name": "240p"},
      {"bandwidth_ffmpeg": "800k", "bandwidth": 800000, "resolution": "854x480", "name": "480p"},
      {"bandwidth_ffmpeg": "1400k", "bandwidth": 1400000, "resolution": "1280x720", "name": "720p"},
